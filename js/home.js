...
IT.home = (function () {
  ...
  var refs = {
    ...
    perfilColor: IT.$("#perfil-color"), perfilBio: IT.$("#perfil-bio"), perfilPin: IT.$("#perfil-pin"),
  ...
  function guardarPerfil() {
    ...
    var nuevo = {
      ...
      emoji: emojiSel, bio: refs.perfilBio.value.trim().slice(0, 60),
      pin: refs.perfilPin.value.trim().slice(0, 6), color: colorSel,
      created: p.created || Date.now()
    };
    D.ref("users/" + u).set(nuevo);
