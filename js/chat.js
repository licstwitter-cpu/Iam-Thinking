...
IT.chat = (function () {
  ...
  var TEMAS = [
    { k: "rosa", n: "Amor 💕", m: "linear-gradient(135deg,#FB9FC0,#E85D90)" },
    { k: "lavanda", n: "Lavanda 💜", m: "linear-gradient(135deg,#C9A6EE,#9A6FD8)" },
    { k: "cielo", n: "Cielo 💙", m: "linear-gradient(135deg,#9DD0FA,#5AA6E8)" },
    { k: "menta", n: "Menta 🌿", m: "linear-gradient(135deg,#8FE0B0,#4BB87D)" },
    { k: "sol", n: "Sol ☀️", m: "linear-gradient(135deg,#F8C45F,#F0A941)" },
    { k: "noche", n: "Noche 🌙", m: "linear-gradient(135deg,#7D8FE0,#5A6FC9)" }
  ];
  ...
  function aplicarTema(k) {
    if (!TEMAS.some(function (t) { return t.k === k; })) k = "rosa";
    refsUI.tema.dataset.tema = k;
  }
  function temaActual() { return (refsUI.tema.dataset.tema || "rosa"); }
